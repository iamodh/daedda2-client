    ...
    <ul className="flex flex-col gap-4">
      {Array.from({ length: 4 }).map((_, idx) => (
        <li
          ...
          key={idx}
        >
          <div className="flex flex-col gap-0.5 flex-grow *:rounded-sm">
            <div className="w-4/5 md:h-7 h-6  bg-slate-200" />
            <div className="w-2/5 md:h-5 h-4  bg-slate-200" />
            <div className="w-4/5 md:h-7 h-6  bg-slate-200" />
            <div className="w-3/5 md:h-5 h-4  bg-slate-200" />
          </div>
